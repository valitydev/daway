...
ALTER TABLE dw.withdrawal
    ADD COLUMN IF NOT EXISTS exchange_amount_from bigint;
ALTER TABLE dw.withdrawal
    ADD COLUMN IF NOT EXISTS exchange_currency_from character varying;
ALTER TABLE dw.withdrawal
    ADD COLUMN IF NOT EXISTS exchange_amount_to bigint;
ALTER TABLE dw.withdrawal
    ADD COLUMN IF NOT EXISTS exchange_currency_to character varying;